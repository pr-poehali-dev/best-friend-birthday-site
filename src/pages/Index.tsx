          ...
          <div className="mt-8">
            <Dialog>
              <DialogTrigger asChild>
                <Button size="default" className="text-sm px-5 py-4 shadow-lg hover:shadow-xl transition-all">Поздравления от не менее значимых для тебя людей)</Button>
              </DialogTrigger>
        ...
        <section className="mb-20 animate-fade-in" style={{ animationDelay: '0.8s' }}>
          <div className="bg-gradient-to-br from-purple-100 via-pink-50 to-rose-100 rounded-3xl p-12 shadow-2xl border-4 border-purple-200">
            ...
            <div className="max-w-4xl mx-auto space-y-6 text-lg text-gray-800 leading-relaxed">
              ...
              <p>В этот особенный день я хочу сказать тебе то, что не всегда успеваю выразить словами в повседневной жизни. Ты - невероятный человек, и я безмерно благодарен судьбе за то, что она свела нас вместе.</p>
              <p>
              ...
              <p>Благодарю тебя за каждый наш разговор, за каждый смех, за каждую игру по звонку. Ты делаешь мир вокруг меня ярче и теплее. Даже в самые трудные моменты, когда кажется, что всё рушится, ты находишь слова, которые возвращают мне веру в себя и в будущее.</p>
              <p>Ты - тот человек, с которым можно молчать и это будет комфортно, с которым можно говорить часами и не заметить, как пролетело время. Ты всегда в любой момент способна создать мем или сказать фразу, которую я ещё долго буду тебе припоминать. И ты всегда рядом, когда мне нужна поддержка.</p>
              ...
              <p>Помни, что ты - удивительная, сильная, талантливая и невероятно красивая (и внешне, и внутренне). Не позволяй никому и ничему убедить тебя в обратном. Ты заслуживаешь всего самого лучшего в этом мире!</p>
